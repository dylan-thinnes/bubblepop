...
-- Remove module names, TODO move further up behaviour stack
pprName' :: NameIs -> Name -> Doc
pprName' ni (Name occName _) = pprName'' ni (Name occName NameS)
